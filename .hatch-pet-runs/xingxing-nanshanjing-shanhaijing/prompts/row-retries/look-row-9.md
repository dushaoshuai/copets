Create Codex v2 pet look row 9 for `xingxing-nanshanjing-shanhaijing` as exactly 8 full-body frames in this order: 000, 022.5, 045, 067.5, 090, 112.5, 135, 157.5.

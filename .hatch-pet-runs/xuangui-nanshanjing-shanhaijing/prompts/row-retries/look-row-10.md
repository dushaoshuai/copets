Create Codex v2 pet look row 10 for `xuangui-nanshanjing-shanhaijing` as exactly 8 full-body frames in this order: 180, 202.5, 225, 247.5, 270, 292.5, 315, 337.5.

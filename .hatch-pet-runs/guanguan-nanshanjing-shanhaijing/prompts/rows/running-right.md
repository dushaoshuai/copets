Create one horizontal animation strip for Codex pet `guanguan-nanshanjing-shanhaijing`, state `running-right`.
...
Identity: same pet in every frame: Upgrade the existing approved pet atlas to spriteVersionNumber 2. Preserve the exact character identity, style, palette, markings, proportions, and materials from the current atlas; generate only natural looking directions.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
